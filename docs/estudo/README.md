...
| `eventos-esquema.md` | pronto (128 KB) | `sni-ciclo/src/app/api/migrate/route.ts` (31 tabelas) × `supabase/rascunhos/eventos_schema.sql` |
...
| `estrutura-organizacional.md` | pronto (77 KB) | hierarquia institucional nos quatro sistemas + esboço de modelo unificado |
| `esqueleto-main.md` | pronto (58 KB) | auditoria do commit `8cd93fa` (typecheck, testes, contradições, qualidade) |
